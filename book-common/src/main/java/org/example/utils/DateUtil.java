...
public class DateUtil {
   ...
   * matches the nearest half-integer (i.e., a julian date of 1.4 gets changed to 1.5, and 0.9 gets
   * changed to 0.5.)
   *
  ...
  /**
   * Returns the days between two dates. Positive values indicate that the second date is after the
   * first, and negative values indicate, well, the opposite. Relying on specific times is
   * problematic.
   *
  ...
  /**
   * Returns the days between two dates. Positive values indicate that the second date is after the
   * first, and negative values indicate, well, the opposite.
   *
   * @param early
   * @param late
  ...
  /**
   * Return a Julian date based on the input parameter. This is based from calculations found at <a
   * href="http://quasar.as.utexas.edu/BillInfo/JulianDatesG.html">Julian Day Calculations
